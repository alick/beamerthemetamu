...
%\includegraphics[width=\paperwidth,height=\paperheight]{tamu_titlepage_bg.pdf}}
\begin{frame}[plain]
\titlepage
\end{frame}
}
...
\begin{frame}{Pictures in Columns}
  \begin{columns}
    \begin{column}{.5\textwidth}
      \begin{figure}[htbp]
        \centering
        %\includegraphics[width=\textwidth]{tamu_titlepage_bg}
    ...
    \begin{column}{.5\textwidth}
      \begin{figure}[htbp]
        \centering
        %\includegraphics[width=\textwidth]{tamu_finalpage_bg}
...
{
%\usebackgroundtemplate{%
%\includegraphics[width=\paperwidth,height=\paperheight]{tamu_finalpage_bg.pdf}}
\begin{frame}[plain]
\end{frame}
}
\end{document}
